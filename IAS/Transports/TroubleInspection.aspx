...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container" style="font-family: 'Century Gothic', CenturyGothic, AppleGothic, sans-serif; padding-left: 10px; padding-right: 10px; font-size: xx-small">
        ...
        <div class="row">
            <div class="col-lg-2 col-lg-offset-8">
                <asp:Button ID="registrarTroubleBtn" runat="server" ValidationGroup="save" Text="Guardar avería" CssClass="btn btn-primary" OnClick="registrarTroubleBtn_Click" />
            </div>
        </div>
