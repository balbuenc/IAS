                            ...
                            <ContentTemplate>
                                ...
                                <asp:ListView ID="MyCasesListView" runat="server"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="http://aibsql.cloudapp.net/ReportServer/Pages/ReportViewer.aspx?%2fGESTOR_SSRS%2fHistoricoCaso&rs:Command=Render&CaseID=<%# Item.CaseID %>" target="_blank">#</a>
                                            </td>
                                            <td>
