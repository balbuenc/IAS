<%@ Page Title="Aprobaciòn de Siniestros" Language="C#" MasterPageFile="~/IAS_Master.Master" AutoEventWireup="true" CodeBehind="ApprovementClaim.aspx.cs" Inherits="IAS.Claims.ApprovementClaim" %>
                        ...
                        <%--<div class="container">
                            <div class="form-horizontal" style="font-size: small">
                                <div class="row alert-info" style="padding-top: 10px; padding-bottom: 10px">
                                    ...
                                    <div class="col-lg-4">Nro. Poliza:<asp:Label ID="PolicyNumberLabel" runat="server" Text='<%# Eval("PolicyNumber") %>' /></div>
                                </div>
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                    <div class="col-lg-1">Nro.</div>
                                    <div class="col-lg-3">
                                        <asp:TextBox ID="txtClaimNumber" runat="server" Text='<%# Eval("ClaimNumber") %>' CssClass="form-control" />
                                    </div>
                                ...
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                    ...
                                    <div class="col-lg-11">
                                        <asp:TextBox ID="txtRiskName" runat="server" Text='<%# Eval("RiskName") %>' CssClass="form-control" />
                                    </div>
                                </div>
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                    ...
                                    <div class="col-lg-3">
                                        <asp:TextBox ID="txtContactName" runat="server" Text='<%# Eval("ContactName") %>' CssClass="form-control" />
                                    </div>
                                </div>
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                ...
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                    ...
                                    <div class="col-lg-3">
                                        <asp:TextBox ID="txtClaimAddress" runat="server" Text='<%# Eval("ClaimAddress") %>' CssClass="form-control" />
                                    </div>
                                </div>
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                    <div class="col-lg-1">Desc. Siniestro</div>
                                    <div class="col-lg-11">
                                        <asp:TextBox ID="txtClaimDescription" runat="server" Text='<%# Eval("ClaimDescription") %>' CssClass="form-control" />
                                    </div>
                                </div>
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                ...
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                    ...
                                    <div class="col-lg-11">
                                        <asp:TextBox ID="txtLooseDescription" runat="server" Text='<%# Eval("LooseDescription") %>' CssClass="form-control" />
                                    </div>
                                </div>
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                    <div class="col-lg-6 ">
