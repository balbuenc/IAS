<%@ Page Title="Siniestro" Language="C#" MasterPageFile="~/IAS_Master.Master" AutoEventWireup="true" CodeBehind="ClaimDetail.aspx.cs" Inherits="IAS.Claims.ClaimDetail" %>
                            ...
                            <div class="form-horizontal" style="font-size: small">
                                ...
                                <div class="row" style="padding-top: 5px; padding-bottom: 5px">
                                    <div class="col-lg-2 col-lg-offset-10">
                                        <asp:Button ID="UpdateButton" runat="server" Text="Guardar" CommandName="Save" CssClass="btn btn-primary" />
                                    </div>
                                </div>
                            </div>
                        </div>
