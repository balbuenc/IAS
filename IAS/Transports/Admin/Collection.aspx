<%@ Page Title="Pagos de transporte" Language="C#" MasterPageFile="~/Transport.Master" AutoEventWireup="true" CodeBehind="Collection.aspx.cs" Inherits="IAS.Transports.Admin.Collection" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-header">
        <h2>Pagos de transporte</h2>
    </div>
