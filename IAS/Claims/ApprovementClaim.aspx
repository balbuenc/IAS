                        ...
                        <div class="container">
                            <div class="form-horizontal" style="font-size: small">
                                <div class="row alert-info" style="padding-top: 10px; padding-bottom: 10px">
                                 ...
                                 <div class="row">
                                    <div class="col-lg-6 ">
                                        <asp:Button ID="ApprovemnetBtnTop" runat="server" Text="Aprobado por Aseguradora" OnClick="ApprovementBtn_Click" CssClass="btn btn-success" />
                                    </div>
                                    <div class="col-lg-6 ">
                                        <asp:Button ID="DesaprovementBtnTop" runat="server" Text="Rechazado por Aseguradora" OnClick="DisapprovementBT_Click" CssClass="btn btn-danger" />
                                    </div>
                                </div>
