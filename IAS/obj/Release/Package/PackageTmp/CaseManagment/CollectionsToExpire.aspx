...
<%@ Page Title="" Language="C#" MasterPageFile="~/IAS_Master.Master" AutoEventWireup="true" CodeBehind="CollectionsToExpire.aspx.cs" Inherits="IAS.CaseManagment.CollectionsToExpire" %>
                        ...
                        <div>
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:SqlDataSource ID="CollectionsExpiredSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:IASDBContext %>" SelectCommand="[dbo].[sp_get_collections_expired]" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
