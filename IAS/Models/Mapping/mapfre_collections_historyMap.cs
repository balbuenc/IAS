...
{
    public class mapfre_collections_historyMap : EntityTypeConfiguration<mapfre_collections_history>
    {
        public mapfre_collections_historyMap()
        {
            // Primary Key
            this.HasKey(t => t.id);
            ...
            this.ToTable("mapfre_collections_history", "exchange");
