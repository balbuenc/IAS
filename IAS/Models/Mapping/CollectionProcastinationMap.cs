...
{
    public class CollectionProcastinationMap : EntityTypeConfiguration<CollectionProcastination>
    {
        public CollectionProcastinationMap()
        {
            // Primary Key
            this.HasKey(t => new { t.CollectionID, t.PaymentDueDate, t.ReceiptNumber, t.RiskName, t.DebtAmount, t.Status, t.Morozidad });
            ...
            this.Property(t => t.Morozidad)
                .IsRequired()
                .HasMaxLength(20);

            // Table & Column Mappings
            this.ToTable("CollectionProcastination");
            ...
            this.Property(t => t.Morozidad).HasColumnName("Morozidad");
        }
    }
}
